...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2018 at 11:13 AM
...
(7, 6, 2, '2018-12-11 11:11:36', 3600),
...
--
ALTER TABLE `tregistrar`
  MODIFY `fidreg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `troute`
--
ALTER TABLE `troute`
  MODIFY `fidroute` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `tuserdomain`
  MODIFY `fidud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--

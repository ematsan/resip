...
--
-- Host: localhost:3306
-- Generation Time: Dec 10, 2018 at 09:59 AM
...
(3, 6, 2, 'ifH1YMKHfZ_RWxAx5NYTCw..', 6),
...
(3, 3, 2, '2018-12-07 15:45:33', 3600),
(4, 4, 2, '2018-12-07 12:48:16', 3600),
(5, 5, 3, '2018-12-10 09:32:08', 3600),
(6, 5, 4, '2018-12-10 09:32:08', 3600);
...
--
ALTER TABLE `tuser`
  MODIFY `fiduser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
